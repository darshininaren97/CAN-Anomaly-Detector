"""
rules/r005.py
Rule R-005: Contradictory Signal Rule Framework.
...
class Rule005(BaseRule):
    """
    R-005: Contradictory Signal Rule Framework.
    
    NOTE: As per project specification, R-005 logic is reserved for official project definition.
    ...
    def __init__(self, condition_fn: Optional[Callable[[CANFrame, Dict[str, DecodedSignal], SignalHistory], Optional[Anomaly]]] = None):
        super().__init__(
            rule_id="R-005",
            name="Contradictory Signal Rule 005 [Pending Specification]",
            anomaly_type=AnomalyType.CONTRADICTORY_SIGNAL.value,
            description="Framework for R-005 contradiction rule. Requires official project specification.",
